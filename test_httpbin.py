...
import bl_api_search
from bl_api_search.helpers import parse_multi_value_header
...
class HttpbinTestCase(unittest.TestCase):
    ...
    def setUp(self):
        bl_api_search.app.debug = True
        self.app = bl_api_search.app.test_client()
    ...
    def test_post_body_text(self):
        with open('bl_api_search/core.py') as f:
    ...
    def test_digest_auth_with_wrong_password(self):
        ...
        response = self.app.get(
            ...
            environ_base={
                # bl_api_search's digest auth implementation uses the remote addr to
                # build the nonce
